...
<!-- HERO SECTION: Cabeçalho com perfil do usuário -->
<div class="hero">
  <!-- Avatar do usuário -->
  ...
  <div>
    ...
    <?php if (!empty($rewards)): ?>
      <!-- Título da seção de recompensas -->
      <div class="small" style="margin:6px 0 4px">Recompensas conquistadas</div>
      <!-- Container das imagens das recompensas -->
      <div class="rewards">
        <?php foreach ($rewards as $src): ?>
          <!-- Imagem individual da recompensa -->
...
<!-- KPI SECTION: Cards de métricas principais -->
<div class="kpis">
  <!-- KPI 1: Atividades pendentes -->
  <div class="kpi">
  ...
  <!-- KPI 2: Atividades em atraso (link clicável) -->
...
<div class="cols">
  ...
  <div class="cardx">
    ...
    <div class="kpis" style="grid-template-columns:repeat(3,1fr);margin-top:4px">
      ...
      <!-- Sub-KPI 2: Treinamentos não iniciados -->
      ...
      <!-- Sub-KPI 3: Treinamentos concluídos -->
      ...
      <div class="tgrid" style="margin-top:12px">
        ...
        <div class="tcard">
          ...
          <div class="inner">
            ...
            <!-- Rodapé com porcentagem e botão de ação -->
            <div class="small" style="display:flex;justify-content:space-between;margin-top:4px">
              <span><?= $pct ?>%</span>
              <!-- Botão de ação contextual (Continuar/Revisar/Começar) -->
